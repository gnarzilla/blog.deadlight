  ...
  '/admin/add-comment/:postId': {
    ...
    POST: async (request, env, ctx) => {
      ...
      try {
        ...
        return Response.redirect(`${getOrigin(request)}/admin/comments/${postId}`);
      } catch (error) {
        logger.error('Error adding comment', { postId, error: error.message });
  ...
  '/admin/comments/reply/:id': {
    ...
    POST: async (request, env, ctx) => {
      ...
      try {
        ...
        return Response.redirect(`${getOrigin(request)}/admin/comments/${parentComment.parent_id || parentComment.thread_id}`);
      } catch (error) {
        logger.error('Error adding reply', { commentId, error: error.message });
    ...
    GET: async (request, env, ctx) => {
      ...
      try {
        ...
        return Response.redirect(
          `${getOrigin(request)}/admin/comments/${comment.parent_post_id || comment.thread_id}`,
          303
        );
